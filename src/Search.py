...
if __name__ == '__main__':
    conn = sqlite3.connect(r'D:\Users\DELL\Desktop\Subway_Info_Analysis_Python-main\res\city_line.db', check_same_thread=False)
    cur = conn.cursor()
    HEIGHT = 800
    WIDTH = 600
    ...
    canvas.pack()
    background_image = tk.PhotoImage(file='../res/bg1.png')
